    ...
    <div className="flex relative flex-col justify-center font-[family-name:var(--font-montserrat)] font-bold mt-32 mx-8">
      <div className="leading-relaxed">
        ...
        <h1 className="w-full text-[40px] font-semibold ">
          Take the stress out of post-event management. We empower
        </h1>
        <h1 className="w-full text-[40px] font-semibold">
          organizers to focus on innovation while we handle the heavy lifting.
        </h1>
        <h1 className="w-full text-[40px] font-semibold ">
          Be the Ninja your participants deserve.
        </h1>
      </div>
      <div className="flex gap-8 mt-4">
        <div className="max-w-[720px]">
          <p className="text-gray-700 text-[16px] mt-16 font-light mb-8">
      ...
      <div className="flex items-center gap-8 ml">
